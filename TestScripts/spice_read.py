...
#     Copyright (C) 2007,2011,2013 Werner Hoch
#
    ...
    def readfile(self,filename):
        ...
        while (1):
            ...
            if keyword == "title":
                ...
                if self.npoints <= 0:
                    print ("Error: No. Points must be greater than zero")
                ...
                if self.real:
                    if keyword == "values":
                        ...
                        a = numpy.frombuffer(f.read(self.nvars*self.npoints*8), dtype="float64")
                    ...
                    if keyword == "values":
                        ...
                        a = numpy.frombuffer(f.read(self.nvars*self.npoints*8*2), dtype="float64")
