  ...
  for keyName in depDirectoryDict:
    ...
    if (args.onlydir == None) or (args.onlydir == keyName):
      ...
      if( keyName == "Xyce_Regression"):
        ...
        outputBuf.write('  set(PYTHON_FOUND FALSE CACHE BOOL "True if python found.")\n')
        outputBuf.write('endif()\n')
        outputBuf.write('if(NOT DEFINED PYTHON_NUMPY_FOUND)\n')
        outputBuf.write('  set(PYTHON_NUMPY_FOUND FALSE CACHE BOOL "True if python package numpy is found.")\n')
        outputBuf.write('endif()\n')
        outputBuf.write('if(NOT DEFINED PYTHON_SCIPY_FOUND)\n')
        outputBuf.write('  set(PYTHON_SCIPY_FOUND FALSE CACHE BOOL "True if python package scipy is found.")\n')
        outputBuf.write('endif()\n')
        outputBuf.write('if(NOT DEFINED PYTHON_PYTEST_FOUND)\n')
        outputBuf.write('  set(PYTHON_PYTEST_FOUND FALSE CACHE BOOL "True if python package pytest is found.")\n')
        outputBuf.write('endif()\n\n')
        outputBuf.write('# Update PYTHON_FOUND from PYTHON_BIN (force so the cache reflects reality)\n')
        outputBuf.write('if(PYTHON_BIN AND NOT (PYTHON_BIN STREQUAL "PYTHON_BIN-NOTFOUND"))\n')
        outputBuf.write('  set(PYTHON_FOUND TRUE CACHE BOOL "True if python found." FORCE)\n')
        outputBuf.write('else()\n')
        outputBuf.write('  set(PYTHON_FOUND FALSE CACHE BOOL "True if python found." FORCE)\n')
        outputBuf.write('endif()\n')
