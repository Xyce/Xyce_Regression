...
def SetUpCtestFiles():
  ...
  for keyName in depDirectoryDict:
    ...
    if( keyName == "Xyce_Regression"):
      ...
      fileObj.write('message(DEBUG "[DBG]: CMAKE_CURRENT_SOURCE_DIR: ${CMAKE_CURRENT_SOURCE_DIR}")\n')
      fileObj.write('set(XYCE_VERIFY "${CMAKE_CURRENT_SOURCE_DIR}/TestScripts/xyce_verify.pl")\n')
      fileObj.write('message(DEBUG "[DBG]: XYCE_VERIFY: ${XYCE_VERIFY}")\n')
      ...
      fileObj.write('  message(STATUS "Adding Xyce_SandiaRegression tests")\n')
      fileObj.write('elseif (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/Xyce_SandiaRegression" AND EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/Xyce_SandiaRegression/CMakeLists.txt" )\n')
      fileObj.write('  add_subdirectory( ${CMAKE_CURRENT_SOURCE_DIR}/Xyce_SandiaRegression Xyce_SandiaRegression)\n')
      fileObj.write('  message(STATUS "Adding Xyce_SandiaRegression tests")\n')
      fileObj.write('endif()\n')
      fileObj.write('# Fastrack Tests\n')
      ...
      fileObj.write('  message(STATUS "Adding Xyce_FasttrackRegression tests")\n')
      fileObj.write('elseif (EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/Xyce_FastrackRegression" AND EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/Xyce_FastrackRegression/CMakeLists.txt")\n')
      fileObj.write('  add_subdirectory( ${CMAKE_CURRENT_SOURCE_DIR}/Xyce_FastrackRegression Xyce_FastrackRegression)\n')
      fileObj.write('  message(STATUS "Adding Xyce_FasttrackRegression tests")\n')
      fileObj.write('endif()\n')
      fileObj.write('# General Tests\n')
