...
CIR1=timeDepMutIndSens.cir
GOLDSCRIPT=./timeDepMutIndSens.cir.SENS.prn.gs.pl

rm -f $CIR1.SENS.prn $CIR1.err $CIR1.SENS.prn.gs $GOLDSCRIPT.err
...
$XYCE_VERIFY --printline=sens $CIR1 $CIR1.SENS.prn.gs $CIR1.SENS.prn
