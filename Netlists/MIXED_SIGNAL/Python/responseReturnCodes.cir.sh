...
@searchstrings = ("return value from initialize is 1",
                  "return value from checkResponseVarName for MAXV1 is 1",
                  "return value from checkResponseVarName for BOGO is 0",
                  "return value from runSimulation is 1",
                  "return value from obtainResponse for BOGO is 0",
                  "obtainResponse value for BOGO = 0.000"
);
