...
# a gold standard
f= open("ADCStateHist.cir.TVarrayData","w+")
...
for i in steps:
  ...
  (result, ADCnames, numADCnames, numPointsArray, timeArray, stateArray) = xyceObj.getTimeStatePairsADCLimitData()
