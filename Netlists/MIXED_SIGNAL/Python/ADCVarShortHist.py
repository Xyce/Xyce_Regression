...
# a gold standard
f= open("ADCVarShortHist.cir.TVarrayData","w+")
...
for i in steps:
  ...
  (result, ADCnames, numADCnames, numPointsArray, timeArray, voltageArray) = xyceObj.getTimeVoltagePairsADCLimitData(maxNumTimeVoltagePairs=10)
