...
$TMPCIRFILE="printLine_for_latch_embedded_nisp_norm.cir";
$TECPLOTFILE="latch_embedded_nisp_norm.cir_ensemble.dat";
$GOLDDAT="goldprn_latch_embedded_nisp_norm.cir_ensemble.dat";
...
{
    $CMD="$XYCE_VERIFY $TMPCIRFILE test_latch_embedded_nisp_norm.cir_ensemble.dat $GOLDDAT > $CIRFILE.prn.out 2> $CIRFILE.prn.err";
    if (system("$CMD") != 0) 
    {
