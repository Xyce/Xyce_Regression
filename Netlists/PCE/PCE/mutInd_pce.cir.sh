...
$TMPCIRFILE="printLine_for_mutInd_pce.cir";
$TECPLOTFILE="mutInd_pce.cir.PCE.dat";
$GOLDDAT="goldprn_mutInd_pce.cir.PCE.dat";
...
{
    $CMD="$XYCE_VERIFY $TMPCIRFILE test_mutInd_pce.cir.PCE.dat $GOLDDAT > $CIRFILE.prn.out 2> $CIRFILE.prn.err";
    if (system("$CMD") != 0) 
    {
