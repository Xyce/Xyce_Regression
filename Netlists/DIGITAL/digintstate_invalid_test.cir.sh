...
@searchstrings = ("Netlist warning in file digintstate_invalid_test.cir at or near line 27",
                  "Device instance UDLTCH!DLTCH1: Invalid DIGINITSTATE: 4. Setting to default",
                  "DIGINITSTATE: 3" );

$retval = $Tools->runAndCheckWarning($CIRFILE,$XYCE,@searchstrings);

# now check that the .prn file is actually correct for the default DIGINITSTATE value of 3
