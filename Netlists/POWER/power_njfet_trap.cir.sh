...
$pCalcColIdx = 4; # P(J1) calculated, via formula
$pXyceColIdx = 2; # P(J1) reported by Xyce 
$wXyceColIdx = 3; # W(J1) reported by Xyce
...
$pCalcColIdx = 5; # P(J1) calculated, from combined source dissipation
$pXyceColIdx = 2; # P(J1) reported by Xyce 
$wXyceColIdx = 3; # W(J1) reported by Xyce
