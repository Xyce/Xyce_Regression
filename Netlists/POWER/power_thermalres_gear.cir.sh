...
$pCalcColIdx = 6; # P(R1) calculated
$pXyceColIdx = 7; # P(R1) reported by Xyce
$wXyceColIdx = 8; # W(R1) reported by Xyce
...
$pCalcColIdx = 10; # P(R2) calculated
$pXyceColIdx = 11; # P(R2) reported by Xyce
$wXyceColIdx = 12; # W(R2) reported by Xyce
