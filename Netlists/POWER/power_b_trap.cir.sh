...
$pCalcColIdx = 3; # P(B1) calculated
$pXyceColIdx = 4; # P(B1) reported by Xyce
$wXyceColIdx = 5; # W(B1) reported by Xyce
...
$pCalcColIdx = 8; # P(B3) calculated
$pXyceColIdx = 9; # P(B3) reported by Xyce
$wXyceColIdx = 10; # W(B3) reported by Xyce
