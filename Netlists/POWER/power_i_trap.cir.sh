...
$pCalcColIdx = 3; # P(i) calculated
$pXyceColIdx = 4; # P(i) reported by Xyce
$wXyceColIdx = 5; # W(i) reported by Xyce

$pR1ColIdx=6; # P(R1) reported by Xyce
$pR2ColIdx=7; # P(R2) reported by Xyce

$wR1ColIdx=8; # W(R1) reported by Xyce
$wR2ColIdx=9; # W(R2) reported by Xyce
...
else
{
  ...
  # increase abstol for the this part of the test. 
  # because currents are in the 1e2 range
  $absTol=1.0e-5;
  $absTol=1.0e-5;
  @colList=($pXyceColIdx,$pR1ColIdx,$pR2ColIdx);
  $retval = PowerCommon::checkPowerBalance(\@prnData,\@colList,$absTol);
}
