...
$pCalcColIdx = 6; # P(M11) calculated, via formula
$pXyceColIdx = 2; # P(M11) reported by Xyce 
$wXyceColIdx = 3; # W(M11) reported by Xyce
...
if ($retval1 != 0)
{
  print "Failed power test for MOSFET M11, based on expected calculation result\n";
}

$pCalcColIdx = 7; # P(M12) calculated, via formula
$pXyceColIdx = 4; # P(M12) reported by Xyce 
$wXyceColIdx = 5; # W(M12) reported by Xyce
...
if ($retval2 != 0)
{
  print "Failed power test for MOSFET M12, based on expected calculation result\n";
}
