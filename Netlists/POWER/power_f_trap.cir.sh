...
$pCalcColIdx = 3; # P(Flin) calculated
$pXyceColIdx = 4; # P(Flin) reported by Xyce
$wXyceColIdx = 5; # W(Flin) reported by Xyce
...
$pCalcColIdx = 8; # P(Fpoly) calculated
$pXyceColIdx = 9; # P(Fpoly) reported by Xyce
$wXyceColIdx = 10; # W(Fpoly) reported by Xyce
