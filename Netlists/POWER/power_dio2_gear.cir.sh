...
$pCalcColIdx = 4; # P(dzr1) calculated
$pXyceColIdx = 5; # P(dzr1) reported by Xyce
$wXyceColIdx = 6; # W(dzr1) reported by Xyce
...
$pCalcColIdx = 9; # P(dzr1) calculated
$pXyceColIdx = 10; # P(dzr1) reported by Xyce
$wXyceColIdx = 11; # W(dzr1) reported by Xyce
