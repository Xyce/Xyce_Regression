...
sub createCircuit
{
    ...
    print $fh ".param PERIOD={1/1MEG}\n";
    print $fh "VIN 1 0 SIN ( 0.0 5.0 1MEGHz)\n";
    print $fh "* specify transmission line with TD parameter\n";
    print $fh "RIN1 1 2 50\n";
    print $fh "* Transmission line has time delay of 1/3 period\n";
    print $fh "TLINE1 2 0 3 0 Z0=50 TD={1.0/3.0*PERIOD}\n";
    ...
    {
        print $fh ".hb 1MEG\n";
        print $fh ".options hbint numfreq=5\n";
