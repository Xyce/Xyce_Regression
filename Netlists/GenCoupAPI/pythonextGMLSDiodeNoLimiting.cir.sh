...
$CIRFILEPY="python_gmls_diode_no_limiting.cir";
$CIRFILEGOLD="diode_no_limiting_nogenext.cir";
...
if (-x $XYCE_LIBTEST) {
  ...
  $CMD="KOKKOS_PROFILE_LIBRARY=\"\" $XYCE_LIBTEST $CIRFILEPY > $CIRFILEPY.out 2> $CIRFILEPY.err";
  print "$CMD\n";
  $result = system("$CMD");
