...
CIR1=nodcpath.cir
CIR2=nodcpath.cir_xyce.cir
CIR2TEMP=$CIR2.temp
GOLDSCRIPT=./nodcpath.cir_xyce.cir.gs.pl
REMOVESLASHR=./nodcpath.cir.pl
...
# Now we have a cleaned up $CIR2 that was put into $CIR2TEMP
