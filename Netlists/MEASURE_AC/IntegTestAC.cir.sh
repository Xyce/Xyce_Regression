...
# to stdout to the "gold" stdout in the $GSFILE (IntegTestACGSfile).
...
# tolerances
my $GSFILE="IntegTestACGSfile";
my $absTol=1e-2; # large absTol because some measure values are around 1e3
my $relTol=1e-3;
my $zeroTol=1e-10;
