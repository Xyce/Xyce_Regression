...
# to stdout to the "gold" stdout in the $GSFILE (AvgTestGSfile).  This
...
foreach $stepNum (1 .. $numSteps)
{
  ...
  # with the "Gold" .maX file, which is in OutputData/MEASURE_AC/STEP/AvgTest.cir.maX
