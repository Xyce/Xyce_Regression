...
system("rm -f $CIRFILE.prn $CIRFILE.out $CIRFILE.err $CIRFILE.mt* $CIRFILE.remeasure.*");
...
$retval = MeasureCommon::checkRemeasureWithFFTFiles($XYCE,$XYCE_VERIFY,$CIRFILE,$absTol,$relTol,$zeroTol,"prn",2);
