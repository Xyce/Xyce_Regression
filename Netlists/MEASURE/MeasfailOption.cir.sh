...
# Zero and One cases.  The .mt0 file for the Bogo case should then be
# identical to the One case.
...
foreach $idx (0 .. 2)
{
  ...
  @searchstrings = ("Netlist warning: .OPTIONS MEASURE MEASFAIL value must be 0 or 1. Setting value",
                    "to 1");
  if ($idx == 2) 
  { 
