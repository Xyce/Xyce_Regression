...
$baseline_unpacked="push_pull_xyce_baseline_unpacked.cir";
$restarted_unpacked="push_pull_xyce_restart_unpacked.cir";

`rm -f $baseline_unpacked.prn $restarted_unpacked.prn`;
`rm -f $baseline_unpacked.err $restarted_unpacked.err`;
`rm -f push_pull_unpacked0*`;
# --------------------------------
...
if (-f "push_pull_unpacked5e-0004")
{
    system("mv push_pull_unpacked5e-0004 push_pull_unpacked0.0005");
}
