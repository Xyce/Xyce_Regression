...
$zeroTol = 1e-15;
$pCalcColIdx = 3; # I(L1)       
$pXyceColIdx = 4; # N(YMIN!K1_L1_BRANCH)
...
$pCalcColIdx = 5; # I(L2)       
$pXyceColIdx = 6; # N(YMIN!K1_L2_BRANCH)
...
$pCalcColIdx = 7; # I(XTXS:L1S)   
$pXyceColIdx = 8; # N(Y:XTXS:MIN!K1S_L1S_BRANCH) 
...
$pCalcColIdx = 9; # I(XTXS:L2S)
$pXyceColIdx = 10; # N(Y:XTXS:MIN!K1S_L2S_BRANCH)
