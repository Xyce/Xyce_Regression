...
# 
my @maxOfVars;
$maxOfVars[0]=$dataFromXyce[0][2];
$maxOfVars[1]=$dataFromXyce[0][3];
$maxOfVars[2]=$dataFromXyce[0][4];
$maxOfVars[3]=$dataFromXyce[0][5];
$maxOfVars[4]=$dataFromXyce[0][2];
$maxOfVars[5]=$dataFromXyce[0][3];
$maxOfVars[6]=$dataFromXyce[0][4];
$maxOfVars[7]=$dataFromXyce[0][5];
