...
@searchstrings = (["Netlist error in file ParameterBlock_extractModelData\\.cir at or near line 16",
    "\\.model line has too few fields"],
   ["Netlist error in file ParameterBlock_extractModelData\\.cir at or near line 19",
    "Unmatched parentheses for .model D1N3940_UMP"]
);
