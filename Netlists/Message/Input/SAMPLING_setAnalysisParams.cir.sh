...
@CIR;
$CIR[0]="SAMPLING_setAnalysisParams1.cir";
$CIR[1]="SAMPLING_setAnalysisParams2.cir";
$CIR[2]="SAMPLING_setAnalysisParams3.cir";

$exitcode = 0;

print "Testing $CIR[0]\n";
@searchstrings = ("STD_DEVIATIONS values for .SAMPLING must be >= 0");
...
print "Testing $CIR[1]\n";
@searchstrings = ("ALPHA values for .SAMPLING must be > 0");
...
print "Testing $CIR[2]\n";
@searchstrings = ("BETA values for .SAMPLING must be > 0");
