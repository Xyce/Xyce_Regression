...
@CIR;
$CIR[0]="ES_setAnalysisParams1.cir";
$CIR[1]="ES_setAnalysisParams2.cir";
$CIR[2]="ES_setAnalysisParams3.cir";

$exitcode = 0;

print "Testing $CIR[0]\n";
@searchstrings = ("STD_DEVIATIONS values for .EMBEDDEDSAMPLING must be >= 0");
...
print "Testing $CIR[1]\n";
@searchstrings = ("ALPHA values for .EMBEDDEDSAMPLING must be > 0");
...
print "Testing $CIR[2]\n";
@searchstrings = ("BETA values for .EMBEDDEDSAMPLING must be > 0");
