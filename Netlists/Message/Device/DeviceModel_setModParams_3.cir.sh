...
# error output.
#@searchstrings = ( "Inconsistent or missing TEMPMODEL parameter, PWL",
                   #"specified here, QUADRATIC specified previously"
@searchstrings = (
 "Netlist error in file DeviceModel_setModParams_3.cir at or near line 14",
