...
# to stdout to the "gold" stdout in the $GSFILE (TrigTargTestNoiseGSfile).  This
...
$GSFILE="TrigTargTestNoiseGSfile";
$absTol=1e-5;
$relTol=1e-3;
$zeroTol=1e-10;
...
foreach $stepNum (1 .. $numSteps)
{
  ...
  # with the "Gold" .maX file, which is in OutputData/MEASURE_CONT/STEP/TrigTargTestAC.cir.maX
