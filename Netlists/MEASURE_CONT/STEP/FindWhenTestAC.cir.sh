...
# to stdout to the "gold" stdout in the $GSFILE (FindWhenTestACGSfile).  This
...
foreach $stepNum (1 .. $numSteps)
{
  ...
  # with the "Gold" .maX file, which is in OutputData/MEASURE_CONT/STEP/FindWhenTestAC.cir.maX
