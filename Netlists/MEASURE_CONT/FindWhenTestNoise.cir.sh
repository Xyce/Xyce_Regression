...
# to stdout to the "gold" stdout in the $GSFILE (FindWhenTestNoiseGSfile).
...
# tolerances
my $GSFILE="FindWhenTestNoiseGSfile";
my $absTol=1e-5;
my $relTol=1e-3;
my $zeroTol=1e-10;
...
# with the "Gold" .ma0 file, which is in OutputData/MEASURE_CONT/
