...
CIR1=devLevelParams_isffm.cir
CIR2=fddevLevelParams_isffm.cir
CIR3=fddevLevelParams_isffm2.cir
CIR4=dummy_devLevelParams_isffm.cir
...
sed '1 s/^.*$/Index  TIME  V(1)  V(1)_V0 V(1)_VA V(1)_FC V(1)_MDI V(1)_FS/g'  $CIR1.SENS.prn > $CIR1.SENS.prn2
sed '1 s/^.*$/Index  TIME  V(1)  V(1)_V0 V(1)_VA V(1)_FC V(1)_MDI V(1)_FS/g'  $CIR2.SENS.prn > $CIR2.SENS.prn2
sed '1 s/^.*$/Index  TIME  V(1)  V(1)_V0 V(1)_VA V(1)_FC V(1)_MDI V(1)_FS/g'  $CIR3.prn > $CIR3.SENS.prn2
