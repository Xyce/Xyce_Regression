...
#$CIR1 = "/Users/erkeite/XYCE/GitRepos/Xyce_Regression/Netlists/SENS/bsim6invDirect.cir";
#$CIR2 = "/Users/erkeite/XYCE/GitRepos/Xyce_Regression/Netlists/SENS/bsim6invDirectFD.cir";
$CIR1 = "bsim6invDirect.cir";
$CIR2 = "bsim6invDirectFD.cir";

`rm -f $CIR1.SENS.prn`;

$retval=$Tools->wrapXyce($XYCE,$CIR1);
if ($retval != 0) { print "$CIR1: Exit code = $retval\n"; exit $retval; }

`rm -f $CIR2.SENS.prn`;
$retval=$Tools->wrapXyce($XYCE,$CIR2);
if ($retval != 0) { print "$CIR2: Exit code = $retval\n"; exit $retval; }
