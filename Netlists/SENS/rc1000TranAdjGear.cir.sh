...
#GOLDPRN=rc1000TranAdjGear.cir.TRADJ.prn.gs
CIR1=rc1000TranAdjGear.cir
...
$XYCE_VERIFY --printline=sens  --debug --verbose $CIR1 $CIR1.TRADJ.prn $CIR1.TRADJ.prn.gs  > $CIR1.debugAndVerbose.out
