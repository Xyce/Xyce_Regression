...
CIR1=devLevelParams_isin.cir
CIR2=fddevLevelParams_isin.cir
CIR3=fddevLevelParams_isin2.cir
CIR4=dummy_devLevelParams_isin.cir
...
sed '1 s/^.*$/Index  TIME    V(1)  V(1)_V0 V(1)_VA V(1)_FREQ V(1)_TD V(1)_THETA V(1)_PHASE/g'  $CIR1.SENS.prn > $CIR1.SENS.prn2
sed '1 s/^.*$/Index  TIME    V(1)  V(1)_V0 V(1)_VA V(1)_FREQ V(1)_TD V(1)_THETA V(1)_PHASE/g'  $CIR2.SENS.prn > $CIR2.SENS.prn2
sed '1 s/^.*$/Index  TIME    V(1)  V(1)_V0 V(1)_VA V(1)_FREQ V(1)_TD V(1)_THETA V(1)_PHASE/g'  $CIR3.prn > $CIR3.SENS.prn2
