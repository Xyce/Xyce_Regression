...
CIR1=sensCapTrapAdjOrder1.cir
GOLDSCRIPT=./sensCapTrapAdjOrder1.cir.TRADJ.prn.gs.pl

rm -f $CIR1.TRADJ.prn $CIR1.err $CIR1.TRADJ.prn.gs $GOLDSCRIPT.err
...
$XYCE_VERIFY --printline=sens $CIR1 $CIR1.TRADJ.prn.gs $CIR1.TRADJ.prn
