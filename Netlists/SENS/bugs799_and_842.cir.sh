...
CIR1=bugs799_and_842A.cir
CIR2=bugs799_and_842D.cir
CIR3=dummy_bugs799_and_842.cir
...
sed '1 s/^.*$/Index       TIME             V(3)       V(3)_R1:R/g'  $CIR1.TRADJ.prn > $CIR1.TRADJ.prn2

sed '1 s/^.*$/Index       TIME             V(3)       V(3)_R1:R/g'  $CIR2.SENS.prn > $CIR2.SENS.prn2
