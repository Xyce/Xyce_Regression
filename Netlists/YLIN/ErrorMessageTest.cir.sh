...
@searchstrings = (["Netlist error: File noValidLines.s1p for model YLIN_MOD1 lacked valid",
     ...
     "noValidLines.s1p for model YLIN_MOD1"],
    ["Netlist error: Invalid \\[Version\\] line in file shortVersionLine.s1p for model",
     "YLIN_MOD2 at line 2"],
    [ "Netlist error: Unsupported \\[Version\\] 2.1 in file invalidVersion.s1p for model",
     "YLIN_MOD3 at line 2"],
    ["Netlist error: Option line not found immediately after \\[Version\\] line in file",
     "noOptionLine.s1p for model YLIN_MOD4 at line 4"],
    ["Netlist error: Invalid \\[Number of Ports\\] line in file shortLines.s1p for model",
     "YLIN_MOD5 at line 4",
