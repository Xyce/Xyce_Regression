...
chomp $GOLDDIR;
$GOLDPRN = "$GOLDDIR/ylin-2port-yparam-matrixFormat.cir";

$XYCE_ACVERIFY = $XYCE_VERIFY;
$XYCE_ACVERIFY =~ s/xyce_verify/ACComparator/;

@CIR;
$CIR[0]="ylin-2port-yparam-matrixFormatLower.cir";
$CIR[1]="ylin-2port-yparam-matrixFormatUpper.cir";
...
if ($retcode == 0) {print "Passed other case (Lower and Upper) comparisons\n"; }
