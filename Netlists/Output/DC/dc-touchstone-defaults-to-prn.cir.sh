...
@searchstrings = ("Netlist warning: DC output cannot be written in Touchstone format, using",
                  "standard format",
                  "Netlist warning: DC output cannot be written in Touchstone format, using",
                  "standard format"
);
