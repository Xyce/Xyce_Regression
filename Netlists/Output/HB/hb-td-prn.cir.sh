...
system("grep -v '.print HB ' $CIRFILE > $CIRFILE.HB_TD.cir");
system("grep -v '.print HB_TD ' $CIRFILE > $CIRFILE.HB.cir");

$CMD="$XYCE_VERIFY $CIRFILE.HB_TD.cir $GOLDPRN.HB.TD.prn $CIRFILE.HB.TD.prn > $CIRFILE.HB.TD.prn.out 2> $CIRFILE.HB.TD.prn.err";
if (system("$CMD") != 0) {
...
$CMD="$XYCE_VERIFY $CIRFILE.HB.cir $CIRFILE.hb_ic.prn $GOLDPRN.hb_ic.prn > $CIRFILE.hb_ic.prn.out 2> $CIRFILE.hb_ic.prn.err";
if (system("$CMD") != 0) {
