...
$CMD="$XYCE_VERIFY $CIRFILE $GOLDPRN.prn $CIRFILE.prn  --goodres=$GOLDDIR/$CIRFILE.res > $CIRFILE.prn.out 2> $CIRFILE.prn.err";
print STDERR " Attempting to execute command:\n$CMD\n";
