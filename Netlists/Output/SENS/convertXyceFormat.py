  ...
  if os.path.exists(file):
    ...
    while match[0] != None:
      ...
      if fields[0] != "DATASETAUXDATA" and \
        ...
        #
        # NOTE: ERK.  For this test, of SENSITIVY tecplot output (also bug 448 on joseki), it is critical 
        # to leave the curly braces in place.  For that reason, this block of code 
        # is commented out.
        #
        #subtag = tag
