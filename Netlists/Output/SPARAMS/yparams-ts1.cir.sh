...
@CIR;
$CIR[0]="yparams-ts1-1port.cir";
$CIR[1]="yparams-ts1-2port.cir";

@GOLD;
$GOLD[0]="yparams-ts1-1port.cir.s1p";
$GOLD[1]="yparams-ts1-1port.cir.ma.s1p";
$GOLD[2]="yparams-ts1-1port.cir.db.s1p";
$GOLD[3]="yparams-ts1-2port.cir.s2p";
$GOLD[4]="yparams-ts1-2port.cir.ma.s2p";
$GOLD[5]="yparams-ts1-2port.cir.db.s2p";
