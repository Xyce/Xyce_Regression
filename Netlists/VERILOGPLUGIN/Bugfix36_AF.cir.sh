...
# gitlab-ex.  This variant tests correct generation of code for case statements
# in analog functions.
...
$VERILOG_SOURCES="toys/Bugfix36_AF.va";

print "Building the plugin...\n";

$result=system("$BUILDXYCEPLUGIN -o toys_Bugfix36_AF $VERILOG_SOURCES .");
if ($result != 0)
{
    print "Plugin creation failed, see Bugfix36_AF_buildxyceplugin.log\n";
    system("mv buildxyceplugin.log Bugfix36_AF_buildxyceplugin.log");
    print "Exit code = 1";
    exit 1;
}
