...
$VERILOG_SOURCES="toys/Bugfix35_AF.va";

print "Building the plugin...\n";

$result=system("$BUILDXYCEPLUGIN -o toys_Bugfix35_AF $VERILOG_SOURCES .");
if ($result != 0)
{
    print "Plugin creation failed, see Bugfix35_AF_buildxyceplugin.log\n";
    system("mv buildxyceplugin.log Bugfix35_AF_buildxyceplugin.log");
    print "Exit code = 1";
    exit 1;
}
