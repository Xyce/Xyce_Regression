...
@CIRLIST = ( "NLPathStepLv2_1.cir",
             "NLPathStepLv2_2.cir",
             "NLPathStepLv2_3.cir");

@STEPRES1 = (2.5E00, 5.0E00,  7.5E00);# gap value

print "Generating NLPathStepLv2.cir.prn.gs\n";
open(GS,">$CIR1.prn.gs");
$first_run=1;
foreach $CIR (@CIRLIST)
{
...
print "Generating NLPathStepLv2.cir.res.gs\n";
$GOLDRES = "NLPathStepLv2.cir.res.gs";
open(GRES,">$GOLDRES");
...
$CMD="$XYCE_VERIFY --goodres=$GOLDRES --testres=NLPathStepLv2.cir.res NLPathStepLv2.cir NLPathStepLv2.cir.prn.gs NLPathStepLv2.cir.prn > NLPathStepLv2.cir.prn.out 2> NLPathStepLv2.cir.prn.err";
