...
@CIRLIST = ( "NLAreaStepLv2_1.cir",
             "NLAreaStepLv2_2.cir",
             "NLAreaStepLv2_3.cir");

@STEPRES1 = (5.0E-2, 1.0E-1,  1.5E-1);# gap value

print "Generating NLAreaStepLv2.cir.prn.gs\n";
open(GS,">$CIR1.prn.gs");
$first_run=1;
foreach $CIR (@CIRLIST)
{
...
print "Generating NLAreaStepLv2.cir.res.gs\n";
$GOLDRES = "NLAreaStepLv2.cir.res.gs";
open(GRES,">$GOLDRES");
...
$CMD="$XYCE_VERIFY --goodres=$GOLDRES --testres=NLAreaStepLv2.cir.res NLAreaStepLv2.cir NLAreaStepLv2.cir.prn.gs NLAreaStepLv2.cir.prn > NLAreaStepLv2.cir.prn.out 2> NLAreaStepLv2.cir.prn.err";
